...
CXXFLAGS += -Ilib/glad/include -Ilib/glfw/include -Ilib/glm -Ilib/stb -Ilib/imgui -Ilib/PerlinNoise
LDFLAGS = -fuse-ld=lld \
	lib/glad/glad.o lib/glfw/build/src/libglfw3.a \
...
.PHONY: all libs compile run clean
